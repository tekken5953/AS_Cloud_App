package app.airsignal.core_databse.db.sp

import android.content.Context
import app.airsignal.core_databse.db.SharedPreferenceManager
import app.airsignal.core_databse.db.sp.SpDao.CURRENT_GPS_ID
import app.airsignal.core_databse.db.sp.SpDao.INITIALIZED_LOC_PERMISSION
import app.airsignal.core_databse.db.sp.SpDao.INITIALIZED_NOTI_PERMISSION
import app.airsignal.core_databse.db.sp.SpDao.IS_INIT_BACK_LOC_PERMISSION
import app.airsignal.core_databse.db.sp.SpDao.IS_PERMED_BACK_LOG
import app.airsignal.core_databse.db.sp.SpDao.LAST_REFRESH22
import app.airsignal.core_databse.db.sp.SpDao.LAST_REFRESH42
import app.airsignal.core_databse.db.sp.SpDao.NOTIFICATION_ADDRESS
import app.airsignal.core_databse.db.sp.SpDao.NOTIFICATION_TOPIC_DAILY
import app.airsignal.core_databse.db.sp.SpDao.WARNING_FIXED
import app.airsignal.core_databse.db.sp.SpDao.lastAddress
import app.airsignal.core_databse.db.sp.SpDao.lastLoginPlatform
import app.airsignal.core_databse.db.sp.SpDao.notiEnable
import app.airsignal.core_databse.db.sp.SpDao.notiSound
import app.airsignal.core_databse.db.sp.SpDao.notiVibrate
import app.airsignal.core_databse.db.sp.SpDao.userEmail
import app.airsignal.core_databse.db.sp.SpDao.userFontScale
import app.airsignal.core_databse.db.sp.SpDao.userLocation
import app.airsignal.core_databse.db.sp.SpDao.userProfile
...
object GetAppInfo {
    ...
    fun getLastRefreshTime42(context: Context): Long {
        return app.airsignal.core_databse.db.SharedPreferenceManager(context).getLong(LAST_REFRESH42)
    }

    fun getLastRefreshTime22(context: Context): Long {
        return app.airsignal.core_databse.db.SharedPreferenceManager(context).getLong(LAST_REFRESH22)
    }
}