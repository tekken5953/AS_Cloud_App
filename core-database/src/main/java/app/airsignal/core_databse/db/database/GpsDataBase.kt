package app.airsignal.core_databse.db.database
...
import app.airsignal.core_databse.db.room.scheme.GpsScheme

@Database(entities = [GpsEntity::class], version = 3, exportSchema = false)
